...
import 'mbx_ekyc_selfie_ktp_controller.dart';

class MbxEkycSelfieKtpScreen extends StatelessWidget {
  const MbxEkycSelfieKtpScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return GetBuilder<MbxEkycSelfieKtpController>(
      ...
      builder: (controller) => MbxScreen(
        title: 'eKYC - Selfie with ID Card',
        backAction: () {
        ...
        scrollingBody: Column(
          ...
          children: [
            ...
            Padding(
              padding: EdgeInsets.symmetric(horizontal: 16.0),
              child: TextX(
                'Hold your ID card next to your face and take a selfie. Make sure both your face and ID card are clearly visible.',
                fontSize: 16.0,
              ...
              child: ContainerX(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ContainerX(height: 8.0),
                    _buildInstruction('• Hold ID card next to your face'),
                    _buildInstruction('• Make sure both are clearly visible'),
                    _buildInstruction('• Keep ID card details readable'),
                    _buildInstruction('• Ensure good lighting'),
                    _buildInstruction('• Avoid glare on the ID card'),
                  ],
                ),
              ),
            ),
