      ...
      builder: (controller) => MbxScreen(
        ...
        scrollingBody: Column(
          ...
          children: [
            ...
            UpgradeLayoutHelper.buildProgressIndicator(4, 6),

            ContainerX(height: 32.0),

            // Step indicator
            UpgradeLayoutHelper.buildStepIndicator('upgrade_step_4_of_6'.tr),

            ContainerX(height: 8.0),

            // Title
            UpgradeLayoutHelper.buildHeader('upgrade_personal_info_header'.tr),
